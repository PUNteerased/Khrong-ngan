...
1. **Software:** boot แล้ว `stopAllServos()` ตัด PWM ทุกช่องครั้งเดียว — **อย่า** pulse 1500μs ซ้ำตอน idle (MG90S 360° จะหมุน)
2. **Hardware (ดีที่สุด):** ต่อขา **OE** ของ PCA9685 ไป GPIO S3 — HIGH = ปิด PWM ทุกช่อง
