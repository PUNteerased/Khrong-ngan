...
const REFUSAL_REPLY =
  "ขออภัยครับ LaneYa เป็นเภสัชกร AI ช่วยประเมินอาการและแนะนำยา OTC อย่างปลอดภัยเท่านั้น ไม่สามารถทำตามคำสั่งที่ขัดกับกฎความปลอดภัยหรือเปลี่ยนบทบาทได้ กรุณาเล่าอาการหรือความต้องการด้านยาให้ฟังนะครับ 🙏"
